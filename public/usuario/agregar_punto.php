		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form action="../../helpers/agregar_punto.php" method="post" enctype="multipart/form-data">
						<input type="hidden" name="ruta" value="<?php echo $id_ruta; ?>">
						...
						<div class="form-group">
							<button type="submit" name="boton" value=1 class="btn btn-primary">Enviar</button>
						</div>
					</form>		
				</div>
				</div>
