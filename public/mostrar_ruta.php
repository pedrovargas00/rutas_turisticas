						...
						<div class="col-md-8">
							<div class="col-md-12 animate-box" style="text-align: center">
								...
								<div class="col-md-12 gtco-puntos-comentarios" style="text-align: justify">
									<figure>
										<?php if ($id_usuario_comentario == 0)
						...
						<div class="col-md-8">
							<div class="col-md-12 animate-box " style="text-align: center">
								...
								<form action="../helpers/guardar_comentario.php" method="POST">
									<input type="hidden" name="formulario" value="formPrincipal">
									...
									<div class="row form-group">
										<div class="col-md-12">
											<p class="clasificacion">
												<!--Utilizar checked para seleccionar el valor predeterminado-->
												<input id="r1" type="radio" name="estrellas" value="5" required>
												<label for="r1">★</label>
												<input id="r2" type="radio" name="estrellas" value="4">
												<label for="r2">★</label>
												<input id="r3" type="radio" name="estrellas" value="3">
												<label for="r3">★</label>
												<input id="r4" type="radio" name="estrellas" value="2">
												<label for="r4">★</label>
												<input id="r5" type="radio" name="estrellas" value="1">
												<label for="r5">★</label>
											</p>
